...
if vector_store == 'ChromaDB':
    ...
    def create_chroma_vector_store(chunks, embeddings_model_path):
        ...
        # 'search_type' parameter defines the method to use while searching the most relevent documants to 
...
if vector_store == 'MilvusDB':
    def create_milvus_vector_store(chunks, embeddings_model_path):
        ...
        # 'search_type' parameter defines the method to use while searching the most relevent documants 
...
**Previous**: [Prepare Data](prepare-data.md) | **Next**: [Milvus Chain](../milvus-embedding-and-langchain/milvus-chain.md)
