...
FROM my-registry.practicus.my-company.com/practicusai/practicus-minimal:25.5.0
...
```
my-registry.practicus.my-company.com/demo/practicus-minimal-my:25.5.0
```
...
worker_config = prt.WorkerConfig(
    ...
    # worker_image="my-registry.practicus.my-company.com/demo/practicus-minimal-my:25.5.0",
