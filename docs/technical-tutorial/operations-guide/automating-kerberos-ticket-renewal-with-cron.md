...
```bash
base64 --decode <<< "" > /var/practicus/lib-install.sh && chmod +x /var/practicus/lib-install.sh && sh /var/practicus/lib-install.sh
```
...
**Previous**: [Admin Pod For User Folder Inspection](admin-pod-for-user-folder-inspection.md) | **Next**: [Delete Specific Trash Folders](delete-specific-trash-folders.md)
